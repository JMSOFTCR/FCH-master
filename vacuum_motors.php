...
<!--              <a href="details.php?id=<?php echo $row['productid']; ?>" class="btn btn-success"><?php echo $name; ?></a>-->
	...
	?>
      ...
      <?php
          if($nro_pagina>1)
              echo "<a href='vacuum_motors.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
              
       for ($i=1; $i<=$can_paginas; $i++){
           if ($i==$nro_pagina)
               echo $i." ";
           else 
               echo "<a href='vacuum_motors.php?num=$i'>$i</a> ";
       } 
          
          if($nro_pagina<$can_paginas)
               echo "<a href='vacuum_motors.php?num=".($nro_pagina+1)."'> Siguiente ></a> ";
