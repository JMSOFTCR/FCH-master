...
<div style="height: 30px;"></div>
     <h1 class="mt-4 mb-3">Floor   
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Floor Care</li>
        <li class="breadcrumb-item active">Pads</li>
      </ol>
  ...
  <div class="card">
    <img class="card-img-top img-fluid" src="POS/<?php if (empty($photo)){echo "upload/noimage.jpg";}else{echo $photo;} ?>" alt="Card image cap" style="width: 100%; height:210px; ">
      ...
      <?php
       ...
       for ($i=1; $i<=$can_paginas; $i++){
           if ($i==$nro_pagina)
               ...
               echo "<a href='pads.php?num=$i'>$i</a> ";
       } 
          
          if($nro_pagina<$can_paginas)
               echo "<a href='pads.php?num=".($nro_pagina+1)."'> Siguiente ></a> ";
