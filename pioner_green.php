...
<body>
    ...
    <div id="A_Equipment" class="flex-container">
      ...
      <?php
       if($nro_pagina>1){
          echo "<a style='color:black;' href='pioner_green.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
       }
       for ($i=1; $i<=$can_paginas; $i++)
       {
          if ($i==$nro_pagina){
               ...
               echo "<a style='color:black;' href='pioner_green.php?num=$i'>$i</a> ";
           }
       } 
       if($nro_pagina<$can_paginas){
           echo "<a style='color:black;' href='pioner_green.php?num=".($nro_pagina+1)."'> Siguiente ></a> "; 
       }
       ?>
      </div>
      <!--End Pagination -->
