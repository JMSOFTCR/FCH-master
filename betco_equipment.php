...
-->
	...
	?>
      ...
      <?php
          if($nro_pagina>1)
              echo "<a href='betco_equipment.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
              
       for ($i=1; $i<=$can_paginas; $i++){
           if ($i==$nro_pagina)
               echo $i." ";
           else 
               echo "<a href='betco_equipment.php?num=$i'>$i</a> ";
       } 
          
          if($nro_pagina<$can_paginas)
               echo "<a href='betco_equipment.php?num=".($nro_pagina+1)."'> Siguiente ></a> ";
