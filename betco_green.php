...
<div class="container">
    ...
    <li class="breadcrumb-item">
        ...
        <li class="breadcrumb-item active">Betco Green Cleaning</li>
      </ol>
...
<!--              <a href="details.php?id=<?php echo $row['productid']; ?>" class="btn btn-success"><?php echo $name; ?></a>-->
	...
	?>
      ...
      <?php
          if($nro_pagina>1)
              echo "<a href='betco_green.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
              
       for ($i=1; $i<=$can_paginas; $i++){
           if ($i==$nro_pagina)
               echo $i." ";
           else 
               echo "<a href='betco_green.php?num=$i'>$i</a> ";
       } 
          
          if($nro_pagina<$can_paginas)
               echo "<a href='betco_green.php?num=".($nro_pagina+1)."'> Siguiente ></a> ";
