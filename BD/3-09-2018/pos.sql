...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-09-2018 a las 05:51:43
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `BorrarIMG` (IN `pPhoto` VARCHAR(100))  BEGIN
  DELETE FROM carousel where photo LIKE CONCAT('%',photo,'%');
END$$
