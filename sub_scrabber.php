...
<body>
    ...
    <div class="container">
        ...
        <!-- Page Heading/Breadcrumbs -->
            ...
            <h1 class="mt-4 mb-3">Sub
                <small>Scrubber</small>
            </h1>

            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a style="color: #000;" href="index.php">Home</a></li>
                <li class="breadcrumb-item"><a style="color: #000;" href="equipment_seccion.php">Sub Scrubber</a></li>
    ...
    <div id="A_Equipment" class="flex-container">
      ...
      <?php
       if($nro_pagina>1){
          echo "<a style='color:black;' href='sub_scrubber.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
       }
       for ($i=1; $i<=$can_paginas; $i++)
       {
          if ($i==$nro_pagina){
               ...
               echo "<a style='color:black;' href='sub_scrubber.php?num=$i'>$i</a> ";
           }
       } 
       if($nro_pagina<$can_paginas){
           echo "<a style='color:black;' href='sub_scrubber.php?num=".($nro_pagina+1)."'> Siguiente ></a> "; 
       }
       ?>
      </div>
      <!--End Pagination -->
