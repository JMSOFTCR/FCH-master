...
<body>
    ...
    if(is_numeric($nro_pagina))
       ...
       $query=mysqli_query($conn,"select * from product where categoryid = 18 order by product_name limit $inicio,$reg_por_pagina");  
    ...
    <div class="container">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Pionner Chemicals</li>
        </ol>
        ...
        <div align="center">
            <?php
       if($nro_pagina>1){
          echo "<a style='color:black;' href='pionner_chemicals.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
       }
       for ($i=1; $i<=$can_paginas; $i++)
       {
          if ($i==$nro_pagina){
               ...
               echo "<a style='color:black;' href='pionner_chemicals.php?num=$i'>$i</a> ";
           }
       } 
       if($nro_pagina<$can_paginas){
           echo "<a style='color:black;' href='pionner_chemicals.php?num=".($nro_pagina+1)."'> Siguiente ></a> "; 
       }
       ?>
        </div>
        <!--End Pagination -->
