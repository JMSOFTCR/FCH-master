...
<body>
    ...
    <div class="container">
        ...
        <!-- Page Heading/Breadcrumbs -->
            ...
            <h1 class="mt-4 mb-3">Floor
                <small>Scrubber Parts</small>
            </h1>

            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a style="color: #000;" href="index.php">Home</a></li>
                <li class="breadcrumb-item"><a style="color: #000;" href="equipment_seccion.php">Floor Scrubber Parts</a></li>
                <li class="breadcrumb-item active">Scrubber Parts</li>
            </ol>  
...
<!--                              <h4>$ <?php echo $price; ?></h4>-->
                              <form action="tires_and_wells.php?id=<?php echo $id; ?>" method="post" name="Detalle">
      ...
      <?php
       if($nro_pagina>1){
          echo "<a style='color:black;' href='floor_scrubber_parts.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
       }
       for ($i=1; $i<=$can_paginas; $i++)
       {
          if ($i==$nro_pagina){
               ...
               echo "<a style='color:black;' href='floor_scrubber_parts.php?num=$i'>$i</a> ";
           }
       } 
       if($nro_pagina<$can_paginas){
           echo "<a style='color:black;' href='floor_scrubber_parts.php?num=".($nro_pagina+1)."'> Siguiente ></a> "; 
       }
       ?>
      </div>
      <!--End Pagination -->
